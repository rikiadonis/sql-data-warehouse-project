...
BEGIN
	...
	-- Truncate & Inser Data Into bronze.cmr_cust_info --
	...
	-- Truncate & Inser Data Into bronze.cmr_prd_info --
	SET @start_time = GETDATE()
	...
	-- Truncate & Inser Data Into bronze.cmr_sales_details --
	SET @start_time = GETDATE()
	...
	-- Truncate & Inser Data Into bronze.erp_cust_az12 --
	SET @start_time = GETDATE()
	...
	-- Truncate & Inser Data Into bronze.erp_loc_a101 --
	SET @start_time = GETDATE()
	...
	-- Truncate & Inser Data Into bronze.erp_px_cat_g1v2 --
	SET @start_time = GETDATE()
